...
When you're done writing your code, add, commit, merge into your master branch, and push to Github. Then, checkout a new branch called `gh-pages`. Push this to Github as well.

Visit `http://username.github.io/about-me` (where `username` is your Github username). Your website should be up and running!
